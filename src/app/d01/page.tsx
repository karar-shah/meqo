...
export default function D01Page() {
  return (
    <div className="flex flex-col w-full items-center flex-1 text-white ">
      <div className="w-full max-w-5xl flex flex-col items-center gap-12 md:gap-16 lg:gap-24 mt-24 md:mt-32 ">
        <h1 className="w-full text-3xl md:text-4xl lg:text-5xl leading-tight font-semibold text-center text-[#d3e978]">
          Wählen Sie einen Prompt aus:
        </h1>

        <div className="flex flex-col items-center gap-8 md:gap-12 w-full max-w-4xl text-left text-lg md:text-xl lg:text-2xl">
          {/* Prompt 1 */}
          <Link href="/e01"
            className="w-full rounded-3xl md:rounded-[48px] bg-white/20 flex items-center justify-center p-8 md:p-12 box-border gap-6 md:gap-8 cursor-pointer hover:bg-white/30 transition-all active:opacity-90 active:scale-[0.99] shadow-xl">
